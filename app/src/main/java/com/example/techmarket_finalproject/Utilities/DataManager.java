...
//                Category.COMPUTER_MONITORS));
        ...
        // Desktops
//        allProducts.add(new Product("DT001", "Desktop A", R.drawable.desktop_a, 150, 4.6, 899.99,
...
//                Category.DESKTOPS));
//        allProducts.add(new Product("DT002", "Desktop B", R.drawable.desktop_b, 170, 4.3, 799.99,
...
//                Category.DESKTOPS));
//        allProducts.add(new Product("DT003", "Desktop C", R.drawable.desktop_c, 160, 4.5, 999.99,
